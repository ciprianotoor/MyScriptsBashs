# Generated by Powerlevel10k configuration wizard on 2026-03-24 at 16:39 CST.
...
# 12h time, vertical separators, blurred heads, slanted tails, 2 lines, disconnected,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    #User                    # username
    #host                  # hostname
    last_command            # last executed shell command
       # =========================[ Line #2 ]=========================
    newline                 # \n
   # os_icon                 # os identifier
    proxmox_version        # proxmox version (https://www.proxmox.com/en/proxmox-ve)
    vcs                     # git status
    newline                 # \n  
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%244Fcon '
  ...
  # Show VPN IP address (instead of just icon).
  typeset -g POWERLEVEL9K_VPN_IP_CONTENT_EXPANSION='%F{81}VPN:%f %F{81}${P9K_CONTENT}%f'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_TIME_PREFIX='%248Fa las '
  ...
  function prompt_last_command() {
    ...
    # Remove any percent sign from the command. This ensures no trailing % is rendered.
    last_cmd=${last_cmd//\%/}
    ...
    # Normalize newline/carriage return.
    last_cmd=${last_cmd//$'\n'/ }
    last_cmd=${last_cmd//$'\r'/ }

    # Colores dinámicos configurables a través de variables globales.
  ...
  function prompt_proxmox_version() {
    ...
    pvever=$(pveversion 2>/dev/null | head -n1)
    [[ -n $pvever ]] || return

    # Quiero formato: pve-manager: 9.1.6
    local pvebase pvever_num
    pvebase=${pvever%%/*}     # pve-manager
    pvever_num=${pvever#*/}   # 9.1.6/71482...
