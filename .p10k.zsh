# Generated by Powerlevel10k configuration wizard on 2026-02-27 at 18:08 CST.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%248Fpor '
  ...
  typeset -g POWERLEVEL9K_VPN_IP_CONTENT_EXPANSION='%81FTailscale: $P9K_CONTENT'
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%70F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%215F⇡$P9K_IP_TX_RATE }%38FLAN: $P9K_IP_IP'
  # Show information for the first network interface whose name matches this regular expression.
  # Run `ifconfig` or `ip -4 a show` to see the names of all network interfaces.
  typeset -g POWERLEVEL9K_IP_INTERFACE='([ew]|vmbr).*'
  # Custom icon.
  ...
  function prompt_last_command() {
    p10k segment -f 208 -i '' -t "$last_command"
  }
